...
extension HrAvailabilityStatusExt on HrAvailabilityStatus {
  String get value {
    switch (this) {
      case HrAvailabilityStatus.available:   return 'AVAILABLE';
      case HrAvailabilityStatus.unavailable: return 'UNAVAILABLE';
      case HrAvailabilityStatus.preferred:   return 'PREFERRED';
      case HrAvailabilityStatus.tentative:   return 'TENTATIVE';
    }
  }
  ...
  Color get color {
    switch (this) {
      case HrAvailabilityStatus.available:   return const Color(0xFF27AE60);
      case HrAvailabilityStatus.unavailable: return const Color(0xFFE74C3C);
      case HrAvailabilityStatus.preferred:   return const Color(0xFF6C47FF);
      case HrAvailabilityStatus.tentative:   return const Color(0xFFF39C12);
    }
  }

  Color get bgColor {
    switch (this) {
      case HrAvailabilityStatus.available:   return const Color(0xFFE8F5E9);
      case HrAvailabilityStatus.unavailable: return const Color(0xFFFFEBEE);
      case HrAvailabilityStatus.preferred:   return const Color(0xFFEDE9FF);
      case HrAvailabilityStatus.tentative:   return const Color(0xFFFFF3E0);
    }
  }

  static HrAvailabilityStatus fromString(String value) {
    switch (value.toUpperCase()) {
      case 'AVAILABLE':   return HrAvailabilityStatus.available;
      case 'UNAVAILABLE': return HrAvailabilityStatus.unavailable;
      case 'PREFERRED':   return HrAvailabilityStatus.preferred;
      case 'TENTATIVE':   return HrAvailabilityStatus.tentative;
      default:            return HrAvailabilityStatus.available;
    }
  }
}
...
class HrAvailabilitySlot {
  ...
  factory HrAvailabilitySlot.fromJson(Map<String, dynamic> json) {
    return HrAvailabilitySlot(
      ...
      timeSlot:     HrTimeSlotExt.fromString(json['timeSlot'] as String),
      startTime:    json['startTime']   as String?,
      endTime:      json['endTime']     as String?,
      availability: HrAvailabilityStatusExt.fromString(
