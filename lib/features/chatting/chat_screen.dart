  ...
  final List<Map<String, dynamic>> _messages = [
    {
      'id': 1,
      'text':
          'Hi Sarah, I have a shift on Friday (8am-6pm). Would you be open to swapping with your Saturday shift?',
      'isMe': false,
      'time': '12:00pm',
      'status': 'read',
    ...
    },
    {
      'id': 2,
      'text':
          'Hi! I can do that, but only if it\'s confirmed early—I have plans.',
      'isMe': true,
      'time': '12:00pm',
      'status': 'read',
    },
    ...
    },
    {
      'id': 4,
      'text':
          'Hi I added money. I\'ve submitted a leave request for 10-14 June due to a family matter...',
      'isMe': true,
      'time': '12:00pm',
      'status': 'read',
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(Iconsax.close_circle, size: 27),
            ),
          ),
        ],
      ),
